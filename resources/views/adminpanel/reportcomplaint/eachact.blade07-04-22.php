                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" id="customer_data" width="100%">
                                        <thead>
                                            <tr>
                                                <th>{{ __('reportcomplaint.act') }}</th>
                                                <th>{{ __('reportcomplaint.new') }}</th>
                                                <th>{{ __('reportcomplaint.request_assign_lo') }}</th>
                                                <th>{{ __('reportcomplaint.assign_lo') }}</th>
                                                <th>{{ __('reportcomplaint.calling_schedule') }}</th>
                                                <th>{{ __('reportcomplaint.request_close') }}</th>
