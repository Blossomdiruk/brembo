            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        <font style=" font-size: 22px"> {{ __('reportcomplaint.officerwise') }} </font> </span>
                    </h1>
                </div>
            </div>
                    ...
                    <div class="widget-body no-padding">
                        <div id="search-complaint-form" class="smart-form">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <section class="col col-4">
                                        <label class="label">{{ __('reportcomplaint.unassign_complaints') }} = <span id="unassigncount"></span></label>
    ...
    <x-slot name="script">
        ...
        <script>
            $(document).ready(function(){
                ...
                fill_datatable();
                get_lo_unassign_complaints();

                function fill_datatable(year = '', month = '', labour_office = '')
                {
                    var dataTable = $('#customer_data').DataTable({
                        ...
                        ajax:{
                            url: "{{ route('report-complaint-officerwise') }}",
                            data:{year:year, month:month, labour_office:labour_office}
                ...
                function get_lo_unassign_complaints(){

                    var labour_office = $('#labour_office').val();
                    $.ajax({
                        type: "GET",
                        url: "{{ url('getLoUnassignComplaints') }}?labour_office=" + labour_office,
                        success: function(res) {
                            if (res) {
                                $("#unassigncount").html(res);
                            } else {
                                //
                            }
                        }
                ...
                $('#button1id').click( function(event) {
                        ...
                        if (isValid) {
                            ...
                            fill_datatable(year, month, labour_office);
                            get_lo_unassign_complaints();
