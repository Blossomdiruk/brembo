            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        <font style=" font-size: 22px"> {{ __('reportcomplaint.eachoffice') }} </font> </span>
                    </h1>
                </div>
            </div>
                                    ...
                                    <table class="table table-bordered data-table" id="customer_data" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('reportcomplaint.manual_count') }}</th>
                                                <th>{{ __('reportcomplaint.online_count') }}</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
            ...
            $(document).ready(function(){
                ...
                function fill_datatable(from_date = '', to_date = '')
                {
                    var dataTable = $('#customer_data').DataTable({
                        ...
                        ajax:{
                            url: "{{ route('report-complaint-eachoffice') }}",
