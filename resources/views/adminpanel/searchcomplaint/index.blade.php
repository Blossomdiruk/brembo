@section('title', 'Search Complaint')
<x-app-layout>
    <x-slot name="header">
<head>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        <font style=" font-size: 22px"> {{ __('searchcomplaint.title') }} </font> </span>
                    </h1>
                </div>
            </div>
                        ...
                        <div id="search-complaint-form" class="smart-form">
                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.external_complaint_no') }} </label>
                                        <label class="input">
                                            <input type="text" id="external_ref_no" name="external_ref_no" value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.internal_complaint_no') }} </label>
                                        <label class="input">
                                            <input type="text" id="ref_no" name="ref_no" value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.identification_no') }} </label>
                                        <label class="input">
                                    ...
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.mobile_no') }} </label>
                                        <label class="input">
                                            <input type="text" id="complainant_mobile" name="complainant_mobile" value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.complainant_name') }} </label>
                                        <label class="input">
                                            <input type="text" id="complainant_full_name" name="complainant_full_name" value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.complaint_category') }} </label>
                                        <!-- <label class="select"> -->
                                    ...
                                    <div class="clearfix"></div>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.province') }} </label>
                                        <!-- <label class="select"> -->
                                    ...
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.district') }} </label>
                                        <!-- <label class="select"> -->
                                    ...
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.city') }} </label>
                                        <!-- <label class="select"> -->
                                    ...
                                    <div class="clearfix"></div>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.labour_officer_to_assign') }} </label>
                                        <!-- <label class="select"> -->
                                    ...
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.employer_name') }} </label>
                                        <!-- <label class="input"> -->
                                    ...
                                    <div class="clearfix"></div>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.epf_no') }} </label>
                                        <label class="input">
                                            <input type="text" id="epf_no" name="epf_no" value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.employee_mem_no') }} </label>
                                        <label class="input">
                                            <input type="text" id="employee_mem_no" name="employee_mem_no" value="">
                                        </label>
                                    </section>
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.current_status') }} </label>
                                        <!-- <label class="select"> -->
                                    ...
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.updated_status') }} </label>
                                        <!-- <label class="select"> -->
                                    ...
                                    <section class="col col-4">
                                        <label class="label">{{ __('searchcomplaint.mail_template') }} </label>
                                        <!-- <label class="select"> -->
                            ...
                            <footer>
                                <button id="button1id" name="button1id" type="submit" class="btn btn-primary">
                                    {{ __('searchcomplaint.search') }}
                                </button>
                                <button name="reset" id="reset" type="button" class="btn btn-default"> {{ __('searchcomplaint.clear') }}</button>
                            </footer>
                        </div>
                    </div>
                    <!-- end widget content -->
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('searchcomplaint.category_list') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
