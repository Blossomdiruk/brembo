@section('title', 'WCA Complaint List')
                ...
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        ...
                        <a href="{{ route('wca-complaint-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('actionpendinglist.wca_complaint_list') }} <br><span class="txt-color-blue" onclick="" style=" text-align: center;display: contents;">{{ $totalWcaComplaint }}</span></button>
                        </a>
                    </div>
                </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('wcacomplaintlist.title') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                    ...
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width='5%' style="text-align:center;">{{ __('wcacomplaintlist.id') }}</th>
                                                <th width='15%' style="text-align: center; font-size: 11px">{{ __('wcacomplaintlist.office') }}</th>
                                                <th width='15%' style="text-align: center; font-size: 11px">{{ __('wcacomplaintlist.maternity_ben_leave') }}</th>
                                                <th width='15%' style="text-align: center; font-size: 11px">{{ __('wcacomplaintlist.child_labour') }}</th>
                                                <th width='10%' style="text-align: center; font-size: 11px">{{ __('wcacomplaintlist.female_emp_night') }}</th>
                                                {{-- <th width='5%' style="text-align: center; font-size: 11px">{{ __('wcacomplaintlist.action') }}</th> --}}
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('wcacomplaintlist.view') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
            ...
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'maternity_ben_leave',
                            name: 'maternity_ben_leave'
                        },
                        {
                            data: 'child_labour',
                            name: 'child_labour'
                        ...
                        {
                            data: 'female_emp_night',
                            name: 'female_emp_night'
                        },
                        {
                            data: 'view',
                            name: 'view',
