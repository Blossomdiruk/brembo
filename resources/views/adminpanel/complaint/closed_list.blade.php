            ...
            <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        ...
                        <a href="{{ route('closed-list') }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('actionpendinglist.close') }} <br><span class="txt-color-blue" onclick="" style=" text-align: center;display: contents;">{{ $closedCount }}</span></button>
                        </a>
                ...
                <!-- <div class="col-lg-12">
                    ...
                    <ul id="sparks" class="" style="position: relative; top: 10px;">
                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto; max-width: auto;  transform: translate(0%, -12%);">
                                <a href="{{ 'action-pending-list' }}">
                                    <h5> {{ __('closedlist.action_pending') }} <span class="txt-color-blue" onclick="" style=" text-align: center">{{ $pendingCount }}</span></h5>
                                </a>
                            </li>

                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto; max-width: auto; transform: translate(0%, -12%);">
                                <a href="{{ route('investigation-ongoing-list') }}">
                                    <h5> {{ __('closedlist.investigation_ongoing') }} <span class="txt-color-blue" onclick="" style=" text-align: center">{{ $ongoingCount }}</span></h5>
                                </a>
                            </li>
                            ...
                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 27px 10px !important; min-width: auto;  max-width: auto; transform: translate(0%, -12%);">
                                <a href="{{ route('recovery-pending-list') }}">
                                    <h5> {{ __('closedlist.recovery_pending') }} <span class="txt-color-blue" style=" text-align: center"><i class=""></i>{{ $recoveryCount }}</span></h5>
                                </a>
                            </li>

                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto;  max-width: auto; transform: translate(0%, -12%);">
                                <a href="{{ route('temporary-closed-list') }}">
                                    <h5> {{ __('closedlist.leagle') }}<span class="txt-color-blue" style=" text-align: center"><i class=""></i>{{ $certificateCount }}</span></h5>
                                </a>
                            </li>

                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto;  max-width: auto; transform: translate(0%, -12%);">
                                <a href="{{ route('temporary-closed-list') }}">
                                    <h5> {{ __('closedlist.plaint') }}<span class="txt-color-blue" style=" text-align: center"><i class=""></i>{{ $chargesheetCount }}</span></h5>
                                </a>
                            </li>

                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto;  max-width: auto; transform: translate(0%, -12%);">
                                <a href="{{ route('temporary-closed-list') }}">
                                    <h5> {{ __('closedlist.temp_close') }}<span class="txt-color-blue" style=" text-align: center"><i class=""></i>{{ $tempClosedCount }}</span></h5>
                                </a>
                            </li>
                            ...
                            <li class="sparks-info sparks-info_active" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 27px 10px !important; min-width: auto;  max-width: auto; transform: translate(0%, -12%);">
                                <a href="{{ route('closed-list') }}">
                                    <h5> {{ __('closedlist.close') }} <span class="txt-color-blue" style=" text-align: center"><i class=""></i>{{ $closedCount }}</span></h5>
                                </a>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                <th width='2%' style="text-align:center;">{{ __('closedlist.id') }}</th>
                                                <th width='21%' style="text-align: center; font-size: 11px">{{ __('closedlist.ref_num') }}</th>
                                                <th width='21%' style="text-align: center; font-size: 11px">{{ __('closedlist.external_ref_no') }}</th>
                                                <th style="text-align: center; font-size: 11px">{{ __('closedlist.complaint_name') }}</th>
                                                <th width='4%' style="text-align: center">{{ __('closedlist.nic') }}</th>
                                                <th width='4%' style="text-align: center">{{ __('closedlist.complainant_mobile') }}</th>
                                                <th width='9%' style="text-align: center; font-size: 11px">{{ __('closedlist.date') }}</th>
                                                <th width='2%' style="text-align:center;">{{ __('actionpendinglist.online_manual') }}</th>
                                                <th width='4%' style="text-align: center; font-size: 11px">{{ __('closedlist.status') }} </th>
                                                <th width='4%' style="text-align: center; font-size: 11px">{{ __('closedlist.view') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
