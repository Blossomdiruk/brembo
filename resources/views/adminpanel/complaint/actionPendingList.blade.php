                ...
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        ...
                        <a href="{{ 'action-pending-list' }}">
                            <button class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('actionpendinglist.action_pending') }} <br><span class="txt-color-blue" onclick="" style=" text-align: center;display: contents;">{{ $pendingCount }}</span></button>
                        </a>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('actionpendinglist.title') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                    ...
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width='2%' style="text-align:center;">{{ __('actionpendinglist.id') }}</th>
                                                <th width='21%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.ref_num') }}</th>
                                                <th width='21%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.external_ref_no') }}</th>
                                                <th style="text-align: center; font-size: 11px">{{ __('actionpendinglist.complaint_name') }}</th>
                                                <th width='9%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.nic') }}</th>
                                                <th width='9%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.complainant_mobile') }}</th>
                                                <th width='4%' style="text-align: center">{{ __('actionpendinglist.date') }}</th>
                                                <th width='2%' style="text-align:center;">{{ __('actionpendinglist.online_manual') }}</th>
                                                <th width='4%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.status') }} </th>
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.action') }}</th>
                                                <th width='5%' style="text-align: center; font-size: 10px">{{ __('actionpendinglist.upload') }}</th>
                                                <th width='4%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.modify') }}</th>
                                                <th width='4%' style="text-align: center; font-size: 11px">{{ __('actionpendinglist.view') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('action-pending-list') }}",
                    order: [ 0, 'desc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
