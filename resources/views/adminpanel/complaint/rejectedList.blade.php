                        ...
                        <ul id="sparks" class="">
                            <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto; max-width: auto;  transform: translate(0%, -12%);">
                                <a href="{{ route('pending-approval-list') }}">
                                    <h5> {{ __('rejectedlist.pending') }} <span class="txt-color-blue" onclick="" style=" text-align: center">{{ $pendingCount }}</span></h5>
                                </a>
                                    ...
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width='5%' style="text-align:center;">{{ __('rejectedlist.id') }}</th>
                                                <th width='23%' style="text-align: center; font-size: 11px">{{ __('rejectedlist.ref_num') }}</th>
                                                <th width='23%' style="text-align: center; font-size: 11px">{{ __('rejectedlist.complaint_name') }}</th>
                                                <th width='12%' style="text-align: center">{{ __('rejectedlist.date') }}</th>
                                                <th width='12%' style="text-align: center; font-size: 11px">{{ __('rejectedlist.nic') }}</th>
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('rejectedlist.status') }} </th>
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('rejectedlist.action') }}</th>
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('rejectedlist.view') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
