@section('title', 'WCA Office Wise Complaint List')
                ...
                <div class="col-lg-12">
                    {{-- <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        ...
                        <a href="{{ route('wca-complaint-list') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('actionpendinglist.wca_complaint_list') }} <br><span class="txt-color-blue" onclick="" style=" text-align: center;display: contents;">{{ $pendingApprovalCount }}</span></button>
                        </a>
                    </div> --}}
                </div>
            </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('wcacomplaintlist.table_heading').' - '.$office_name }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ url('wca-complaint-officewise-list', [Request::segment(2)]) }}",
                    order: [ 0, 'desc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
