@section('title', 'Action Plaint & Charge Sheet')
@php
...
<x-app-layout>
        ...
        <div id="content">
            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        {{ __('actionchargesheet.form_title') }}
                    </h1>
                </div>
            </div>
            {{-- <h1 class="alert alert-info"> {{ __('actionchargesheet.complaint_ref_no') }} : {{ $data->ref_no }} </h1> --}}
            <div>
                <div class="jarviswidget-editbox">
                </div>
                <div class="alert alert-info fade in">
                    <h5><strong>{{ __('actionchargesheet.internal_ref_no') }}</strong> : {{ $data->ref_no }}</h5>
                    <h5><strong>{{ __('actionchargesheet.external_ref_no') }}</strong> : {{ $data->external_ref_no }}</h5>
                </div>
            </div>
            @if ($errors->any())
            ...
            <div class="jarviswidget" id="user_register" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                ...
                <header>
                    ...
                    <h2>{{ __('actionchargesheet.sub_heading') }}</h2>
                ...
                <div>
                    ...
                    <div class="widget-body padding-10">
                        ...
                        <li id="s3A" class="active" >
                            ...
                            <li>
                            <li id="s1A">
                                <a href="#s1" data-toggle="tab" >{{ __('actionchargesheet.action') }}</a>
                            </li>
                            <li id="s5E">
                                <a href="#s2" data-toggle="tab" >{{ __('actionchargesheet.update_status') }}</a>
                            </li>
                        </ul>
                        ...
                        <div id="s3" class="tab-pane fade in active">
                            ...
                            <div id="s1" class="tab-pane fade in">
                                ...
                                <div class="widget-body no-padding">
                                    <fieldset>
                                        <form action="{{ route('forward-pendingchargesheet') }}" enctype="multipart/form-data" method="post" id="chargesheet-action-form" class="smart-form">
                                            @csrf
                                            <div class="row">
                                                <section class="col col-6">
                                                    <label class="label">{{ __('actionchargesheet.action') }}<span style="color: #FF0000;"> *</span> </label>
                                                    {{-- <label class="select"> --}}
                                                        <select name="action_type" id="action_type" class="select2" required>
                                                            <option value=""></option>
                                                            <option {{ ($data->complaint_status) == 'Create_plaint_and_charge_sheet' ? 'selected' : '' }} value="Create_plaint_and_charge_sheet">{{ __('actionchargesheet.created') }}</option>
                                                            <option {{ ($data->complaint_status) == 'Reject_plaint_and_charge_sheet' ? 'selected' : '' }} value="Reject_plaint_and_charge_sheet">{{ __('actionchargesheet.rejected') }}</option>
                                                        </select>
                                                        <i></i>
                                                    {{-- </label> --}}
                                                </section>
                                            ...
                                            <div class="row">
                                                <section class="col col-12" style="width: 100%;">
                                                    <label class="label">{{ __('actionchargesheet.remark') }}</label>
                                                    <label class="textarea">
                                                        <textarea rows="3" id="remark" name="remark"></textarea>
                                                    </label>
                                                </section>
                            ...
                            <div class="tab-pane fade" id="s2">
                                <div class="widget-body no-padding">
                                    <fieldset>
                                        <form action="{{ route('status-update-action-chargesheet-list') }}" enctype="multipart/form-data" method="post" id="update-form" class="smart-form">
                                            @csrf
                                            <div class="row">
                                                <section class="col col-6">
    ...
    <script>
            $(function(){
                ...
                $('#chargesheet-action-form').parsley();
            });
        </script>
        <script>
