                                    ...
                                    <table class="table table-bordered data-table" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width='5%' style="text-align:center;">{{ __('approvedlist.id') }}</th>
                                                <th width='23%' style="text-align: center; font-size: 11px">{{ __('approvedlist.ref_num') }}</th>
                                                <th width='23%' style="text-align: center; font-size: 11px">{{ __('approvedlist.complaint_name') }}</th>
                                                <th width='12%' style="text-align: center">{{ __('approvedlist.date') }}</th>
                                                <th width='12%' style="text-align: center; font-size: 11px">{{ __('approvedlist.nic') }}</th>
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('approvedlist.status') }} </th>
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('approvedlist.action') }}</th>
                                                <th width='5%' style="text-align: center; font-size: 11px">{{ __('approvedlist.view') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
