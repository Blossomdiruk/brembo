        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('calculation', function ($row) {
                    ...
                    $btn = '<a href="' . $calculation_url . '" title="upload"><i class="fa fa-calculator" ></i><span class="air-top-right txt-color-red padding-3" >&nbsp;</span></a>';
                    return $btn;
                })
    ...
    public function getletterTemplates($letterTemplateID, $prefLang, $id)
    {
        ...
        if($letterTemplateID == 7){
            if($gratuityDetails){
                ...
                $gratuityamount = $gratuityDetails->gratuity_amount;
                ...
                $surcharge = $gratuityDetails->surcharge;
                if($gratuityDetails->gratuity_paid_amount != '' && $gratuityDetails->gratuity_paid_amount != 0){
                    $balgratuityamount = "(".$gratuityDetails->gratuity_amount." - ".$gratuityDetails->gratuity_paid_amount.")";
                } else {
                    $balgratuityamount = $gratuityDetails->gratuity_amount;
                }
                $totalgratutity = $gratuityDetails->total_gratuity;
                if($gratuityDetails->wage_type == 1){
                    $lastsalary = $gratuityDetails->received_sal;
                    $calvalue = "(".$gratuityDetails->received_sal."/ 2)";
                } else if($gratuityDetails->wage_type == 2){
                    $lastsalary = $gratuityDetails->received_sal;
                    $calvalue = "".$gratuityDetails->received_sal."x 14";
                } else if($gratuityDetails->wage_type == 3){
                    $lastsalary = $gratuityDetails->received_sal;
                    $calvalue = "(".$gratuityDetails->received_sal."/".$gratuityDetails->working_days.") x 14";
                }
